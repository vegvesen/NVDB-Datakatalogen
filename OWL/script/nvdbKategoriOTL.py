...
sqFileName = 'C:\\DATA\\GitHub\\vegvesen\\NVDB-Datakatalogen\\OWL\\category\\nvdb-kategorivise-otl.sparql'

katQ = """PREFIX nvdb: <https://ontologi.atlas.vegvesen.no/nvdb/core/nvdb-owl#>
...
for row in q_res:
    ...
    if str(row.kid) == '303' or str(row.kid) == '304':
        ...
        kat_o=Graph()
        kat_o.bind("nvdb", Namespace("https://ontologi.atlas.vegvesen.no/nvdb/core/nvdb-owl#"))
        ...
        ont = URIRef('https://ontologi.atlas.vegvesen.no/nvdb/category/nvdb-kategori-' + str(row.kid))
        kat_o.add((ont,RDF.type, OWL.Ontology))
        kat_o.add((ont, OWL.imports, URIRef('https://ontologi.atlas.vegvesen.no/nvdb/core/nvdb-owl')))
