...
function ObjektlisterEgenskaperOgVerdier
	...
	for each katPackage in thePackage.Packages
		...
		if IsNumeric(katPackage.Alias) then
			...
			Repository.WriteOutput "Script", Now & " Pakke med Alias " & katPackage.Alias & " hoppet over...", 0 
		end if
	next
