						...
						if not attr.ClassifierID = 0 then 
							...
							select case attr.Type
								case "CI_Citation"
									...
									range = "<http://def.isotc211.org/iso19115/-1/2014/CitationAndResponsiblePartyInformation#CI_Citation>"
								case "TM_Period"
									'Hardcorded reference to the 19103 ontology
								...
								case "Distance"
									'Hardcorded reference to the 19103 ontology
									range = "<hhttp://def.isotc211.org/iso19103/2015/MeasureTypes#Distance>"					
								case "Length"
									'Hardcorded reference to the 19103 ontology
								...
								case "GM_Point"				
									'Hardcorded reference to GeoSPARQL
